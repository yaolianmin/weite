...
class admin_company_controller extends adminCommon{
	...
	function morder_action(){
	    ...
	    $search_list[]=array("param"=>"typedd","name"=>'订单类型',"value"=>array("1"=>"会员充值","2"=>"".$this->config['integral_pricename']."充值","3"=>"银行转帐","4"=>"金额充值","5"=>"购买增值包","7"=>"购买小程序",'8'=>'分享职位赏金','9'=>'悬赏职位赏金'));
